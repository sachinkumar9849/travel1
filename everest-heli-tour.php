        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 mx-auto">
                        ...
                        <div class="container">
                            <div class="pkg-info-card">
                                <div class="pkg-info-grid">
                                    ...
                                    <div class="pkg-info-item">
                                        <div class="pkg-icon"><img src="image/des/max.svg" alt="Elevation"
                                    ...
                                    <div class="pkg-info-item">
                                        <div class="pkg-icon"><img src="image/des/transport.svg" alt="Distance"
                                    ...
                                    <div class="pkg-info-item">
                                        <div class="pkg-icon"><img src="image/des/grade.svg" alt="Grade"
                                                onerror="this.src='https://cdn-icons-png.flaticon.com/512/190/190411.png'"
                                                width="20">
                                        </div>
                                        <div class="pkg-info-text">
                                    ...
                                    <div class="pkg-info-item">
                                        <div class="pkg-icon"><img src="image/des/active.svg" alt="Season"
                                                onerror="this.src='https://cdn-icons-png.flaticon.com/512/1163/1163661.png'"
                                                width="20">
                                        </div>
                                        <div class="pkg-info-text">
                                            <span>Activity</span>
                                            <strong>Heli Landing Tour</strong>
                                        </div>
                                    </div>
                                    <div class="pkg-info-item">
                                        <div class="pkg-icon"><img src="image/des/best.svg" alt="Duration"
                                    ...
                                    <div class="pkg-info-item">
                                        <div class="pkg-icon"><img src="image/des/duration.svg" alt="Meals"
                                                onerror="this.src='https://cdn-icons-png.flaticon.com/512/3565/3565406.png'"
                                                width="20">
                                        </div>
                                        <div class="pkg-info-text">
                                            <span>Duration</span>
                                    ...
                                    <div class="pkg-info-item">
                                        <div class="pkg-icon"><img src="image/des/group.svg" alt="Accommodation"
                                                onerror="this.src='https://cdn-icons-png.flaticon.com/512/25/25694.png'"
                                                width="20">
                                        </div>
                                        <div class="pkg-info-text">
                                            <span>Group Size</span>
                                            <strong>1–5 people (shared)</strong>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <section class="package-overview-section" id="overview">
                        <div class="container">
                            <div class="pkg-overview-content">
                                ...
                                <h2 class="pkg-section-title">The whole Khumbu, in one morning. <span
                                        class="cursive-gold">in one
                                        morning</span></h2>

                                <p class="pkg-desc">The Everest Helicopter Tour carries you over the land of the Sherpas
                                    in the
                                    Solukhumbu region — hovering more than
                                    4,000 m above Kathmandu for an aerial audience with the world's highest mountain.
                                    You see Everest
                                    Base Camp (5,364 m)
                                    and Kala Patthar (5,644 m) ringed by Lhotse, Nuptse and Ama Dablam, then land for
                                    breakfast with the
                                    giants. Instead of
                                ...
                                <div class="pkg-highlight-box">
                                    ...
                                    <p>Travellers short on time or wanting the Everest milestone without the altitude
                                        grind — families,
                                        honeymooners, and anyone who'd rather earn the view from a window seat. No
                                        trekking experience
                                ...
                                <ul class="pkg-highlights-list">
                                    <li><span class="hl-check"><i class="fa-solid fa-check"></i></span> Witness Mt.
                                        Everest (8,848.86 m
                                        / 29,031 ft) — the highest point on Earth — at eye level.</li>
                                    <li><span class="hl-check"><i class="fa-solid fa-check"></i></span> Scenic 360°
                                        passes of Lhotse
                                    ...
                                    <li><span class="hl-check"><i class="fa-solid fa-check"></i></span> Aerial views of
                                        the Khumbu
                    ...
                    <section class="heli-glimpse-section bgRemove" id="photo-gallery">
                        <div class="container">
                    ...
                    <section class="heli-plan-section bgRemove pt-0" id="itinerary">
                        <div class="container">
                            <div class="heli-plan-header">
                                <h2 class="heli-plan-title">The Flight Plan</h2>
                                <p class="heli-plan-subtitle">One day, six moves &mdash; Kathmandu out to Kala Patthar
                                    and back, with a
                    ...
                    <section>
                        <div class="container">
                            ...
                            <img class="w-100" src="image/map.svg" alt="img">
                        </div>
