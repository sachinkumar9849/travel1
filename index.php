...
<section class="nn-hero">
    ...
    <div class="nn-hero__search-wrap">
      <form class="nn-search" role="search" onsubmit="return false;">
        <input type="text" class="nn-search__input"
          placeholder="Search your trip &mdash; Everest, Annapurna, Mustang&hellip;"
  ...
  <ul class="nn-hero__features">
    <li class="nn-feature"><span class="nn-feature__icon"><i class="fa-solid fa-route"></i></span><span class="nn-feature__label">Customizable Itineraries</span></li>
    <li class="nn-feature"><span class="nn-feature__icon"><i class="fa-solid fa-person-hiking"></i></span><span class="nn-feature__label">Guided Adventures</span></li>
    <li class="nn-feature"><span class="nn-feature__icon"><i class="fa-solid fa-mountain-sun"></i></span><span class="nn-feature__label">Local Trails</span></li>
    <li class="nn-feature"><span class="nn-feature__icon"><i class="fa-solid fa-seedling"></i></span><span class="nn-feature__label">Eco-Friendly Travel</span></li>
  </ul>
</section>
  ...
  <div class="container">
    <div class="row align-items-start g-4 nn-dest__head">
      ...
      <div class="col-lg-4 offset-lg-1">
        <p class="nn-lead">We build trips across the central Himalaya &mdash; from the Annapurna teahouses to the Tibetan plateau and the monasteries of Bhutan. Pick a country, or let us thread two together.</p>
      </div>
    </div>
      ...
      <div class="swiper nn-dest-swiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <article class="nn-dcard nn-dcard--photo" style="background-image:url('https://images.unsplash.com/photo-1486911278844-a81c5267e227?auto=format&amp;fit=crop&amp;w=1000&amp;q=80');">
              ...
              <div class="nn-dcard__body">
                ...
                <p class="nn-dcard__desc">Eight of the world's fourteen 8,000-metre peaks. Teahouse trails, restricted-area treks, and the only country where you can summit at dawn and be in jungle by dinner.</p>
                <div class="nn-dcard__foot"><span class="nn-dcard__meta">62 Trips &middot; 9 Regions</span><a href="#" class="nn-dcard__view">View <span class="nn-dcard__arrow"><i class="fa-solid fa-arrow-right"></i></span></a></div>
              </div>
            </article>
          </div>
          <div class="swiper-slide">
            <article class="nn-dcard nn-dcard--photo" style="background-image:url('https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&amp;fit=crop&amp;w=1000&amp;q=80');">
              <div class="nn-dcard__shade"></div>
              <div class="nn-dcard__body">
                <span class="nn-dcard__badge">Permit Required</span>
                <h3 class="nn-dcard__title">Tibet</h3>
                <p class="nn-dcard__desc">The high plateau &mdash; Lhasa, Everest North Base Camp, Kailash kora. All trips on our group-permit framework.</p>
                <div class="nn-dcard__foot"><span class="nn-dcard__meta">9 Trips</span><a href="#" class="nn-dcard__view">View <span class="nn-dcard__arrow"><i class="fa-solid fa-arrow-right"></i></span></a></div>
              </div>
            </article>
          </div>
          <div class="swiper-slide">
            <article class="nn-dcard nn-dcard--solid">
              <div class="nn-dcard__body">
                ...
                <p class="nn-dcard__desc">Druk Path, Jomolhari, Tiger's Nest. A measured pace through dzongs, prayer-flag passes, and the last Himalayan kingdom.</p>
                <div class="nn-dcard__foot"><span class="nn-dcard__meta">7 Trips</span><a href="#" class="nn-dcard__view">View <span class="nn-dcard__arrow"><i class="fa-solid fa-arrow-right"></i></span></a></div>
              </div>
            </article>
          </div>
        </div>
  ...
  <div class="container">
    <div class="row g-5 align-items-center">
      ...
      <div class="col-lg-6">
        ...
        <blockquote class="nn-story__quote">&ldquo;I spent eleven years carrying loads for other people's companies before I started this one. North Nepal exists because the trekkers I walked with kept asking why the agency didn't just hire the guide directly. So we did.&rdquo;</blockquote>
        <p class="nn-body">Founded in 2015, North Nepal Travel &amp; Trek was the brainchild of Mohan Bhandari, the guide himself &mdash; envisioned to fill the gap that he encountered during his guiding days. Born out of this passion, North Nepal Trek is on a mission to provide authentic, high-value, and transformative journeys.</p>
        <p class="nn-body">Ten years on, we're a team of 22 guides, porters, cooks, and trip planners &mdash; and we still build every trek the way we did the first one: a phone call, a few questions, and a route drawn from twenty years of actually walking the trails.</p>
    ...
    <div class="row align-items-end g-4 mb-5">
      <div class="col-lg-5">
        ...
        <h2 class="nn-h2">Best of <em class="nn-green-i">North Nepal Trek.</em></h2>
              <p class="nn-lead mb-0">Five hand-picked routes from our 40+ trek catalogue &mdash; the ones our trekkers walk again and recommend most. Every itinerary is a starting point; we'll reshape it to fit you.</p>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <article class="nn-tcard">
              <div class="nn-tcard__img" style="background-image:url('https://images.unsplash.com/<?= $t[7] ?>?auto=format&amp;fit=crop&amp;w=800&amp;q=80');">
                <span class="nn-tcard__tags"><span><i class="fa-regular fa-calendar"></i> <?= $t[1] ?></span><span><i class="fa-solid fa-mountain"></i> <?= $t[2] ?></span></span>
              ...
              <div class="nn-tcard__body">
                ...
                <div class="nn-tcard__rating"><span class="nn-stars">&#9733;&#9733;&#9733;&#9733;&#9733;</span> <strong><?= $t[3] ?></strong> <span class="nn-muted">(<?= $t[4] ?>)</span></div>
  ...
  <div class="container">
    <div class="row align-items-end g-4">
      <div class="col-lg-7">
        ...
        <h2 class="nn-h2">Nine valleys.<br /><em class="nn-green-i">Nine entirely different worlds.</em></h2>
      </div>
      <div class="col-lg-5">
        <p class="nn-lead mb-0">Each region has its own pace, terrain, and culture. Pick by what you want the days to feel like &mdash; not by mountain name.</p>
      </div>
    </div>
    ...
    <div class="nn-region__grid">
      <?php
      $regions = [
        ['Everest','12 treks','photo-1486911278844-a81c5267e227'],
      ...
      <a href="#" class="nn-rcard" style="background-image:url('https://images.unsplash.com/<?= $r[2] ?>?auto=format&amp;fit=crop&amp;w=700&amp;q=80');">
        <span class="nn-rcard__shade"></span>
        <span class="nn-rcard__body"><span class="nn-rcard__count"><?= $r[1] ?></span><span class="nn-rcard__name"><?= $r[0] ?></span></span>
      </a>
      <?php endforeach; ?>
    </div>
  </div>
...
<section class="nn-sec nn-planner">
  <div class="container">
    <div class="row g-5 align-items-center">
      <div class="col-lg-5">
        <span class="nn-eyebrow nn-eyebrow--light"><span class="nn-eyebrow__line"></span>Trip Planner</span>
        <h2 class="nn-h2 nn-h2--light">Find your perfect plan <em class="nn-green-i">in few questions.</em></h2>
        <p class="nn-lead nn-lead--light">Not a quiz, exactly. More like the same three questions our trip planners ask everyone on the first phone call.</p>
        <p class="nn-planner__hint"><i class="fa-regular fa-clock"></i> ~30 seconds &mdash; we won't ask for your email until the end</p>
      </div>
      <div class="col-lg-7">
        <div class="nn-quiz">
          <div class="nn-quiz__bar"><span style="width:33%"></span></div>
          <h3 class="nn-quiz__q">What draws you to Nepal most?</h3>
          <div class="nn-quiz__opts">
            <button class="nn-opt"><span class="nn-opt__ico">&#9968;</span><strong>Iconic summits</strong><span>Everest, Annapurna &mdash; the mountains you grew up reading about.</span></button>
            <button class="nn-opt"><span class="nn-opt__ico">&#9784;</span><strong>Villages &amp; culture</strong><span>Monasteries, teahouses, family-run kitchens above 3,000m.</span></button>
            <button class="nn-opt"><span class="nn-opt__ico">&#128506;</span><strong>Off the main routes</strong><span>Manaslu, Tsum, Upper Mustang. Fewer trekkers, more wildness.</span></button>
            <button class="nn-opt"><span class="nn-opt__ico">&#9889;</span><strong>A light first taste</strong><span>Poon Hill, Ghorepani &mdash; short walks, big views, no altitude.</span></button>
          </div>
          <div class="nn-quiz__nav">
            <button class="nn-btn nn-btn--ghost"><i class="fa-solid fa-arrow-left"></i> Back</button>
            <button class="nn-btn nn-btn--green">Continue <i class="fa-solid fa-arrow-right"></i></button>
          </div>
        </div>
      </div>
    </div>
...
<section class="nn-sec nn-beyond">
  <div class="container">
    <div class="row align-items-end g-4">
      ...
      <div class="col-lg-5">
        <p class="nn-lead mb-0">Not every traveller comes for the high passes. Add a few days &mdash; or build the whole trip around the temples, the cities and the lowland jungle.</p>
      </div>
    </div>

    <div class="nn-tabs" data-tabs>
      <button class="nn-tab is-active">Cultural</button>
      <button class="nn-tab">Urban</button>
      <button class="nn-tab">Jungle</button>
      <button class="nn-tab">Alpine</button>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-6 col-xl-3">
        <article class="nn-bcard">
          <div class="nn-bcard__img" style="background-image:url('https://images.unsplash.com/<?= $b[5] ?>?auto=format&amp;fit=crop&amp;w=700&amp;q=80');">
...
<section class="nn-sec nn-heli">
  <div class="container">
    <div class="row align-items-end g-4">
      ...
      <div class="col-lg-5">
        <p class="nn-lead mb-0">The postcard views of the high Himalaya &mdash; without the two-week walk in. Lift off at dawn, stand among the giants by breakfast, home for dinner.</p>
      </div>
    </div>

    <div class="nn-chips">
      <button class="nn-chip is-active"><i class="fa-solid fa-plane-up"></i> Half-day</button>
      <button class="nn-chip"><i class="fa-solid fa-plane-up"></i> 1 Day</button>
      <button class="nn-chip"><i class="fa-solid fa-place-of-worship"></i> Pilgrim</button>
      <button class="nn-chip"><i class="fa-solid fa-plane-up"></i> Day-trip</button>
    </div>
    ...
    <div class="nn-rel">
      <div class="swiper nn-heli-swiper">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <article class="nn-tcard">
              <div class="nn-tcard__img" style="background-image:url('https://images.unsplash.com/<?= $h[7] ?>?auto=format&amp;fit=crop&amp;w=800&amp;q=80');">
                <span class="nn-tcard__tags"><span><i class="fa-regular fa-clock"></i> <?= $h[1] ?></span><span><i class="fa-solid fa-mountain"></i> <?= $h[2] ?></span></span>
                <button class="nn-tcard__heart" aria-label="Save"><i class="fa-regular fa-heart"></i></button>
              </div>
              <div class="nn-tcard__body">
                <h3 class="nn-tcard__title"><?= $h[0] ?></h3>
                <div class="nn-tcard__rating"><span class="nn-stars">&#9733;&#9733;&#9733;&#9733;&#9733;</span> <strong><?= $h[3] ?></strong> <span class="nn-muted">(<?= $h[4] ?>)</span></div>
...
<section class="nn-sec nn-promise">
  <div class="container">
    <div class="row g-5">
      <div class="col-lg-5">
        <span class="nn-eyebrow nn-eyebrow--light"><span class="nn-eyebrow__line"></span>Our Promise</span>
        <h2 class="nn-h2 nn-h2--light">Numbers we keep <em class="nn-green-i">even when nobody's watching.</em></h2>
        <p class="nn-lead nn-lead--light">Anyone can write &ldquo;ethical&rdquo; on a website. These are the four numbers we publish, audit annually, and will refund your deposit if we miss. They're not aspirational &mdash; they're the floor.</p>
      </div>
      <div class="col-lg-7">
        <div class="row g-4 nn-stats">
          <?php
          $stats = [
          ...
          <div class="col-sm-6">
            <div class="nn-stat">
              <div class="nn-stat__num"><?= $s[0] ?><span><?= $s[1] ?></span></div>
              <h4 class="nn-stat__title"><?= $s[2] ?></h4>
              <p class="nn-stat__desc"><?= $s[3] ?></p>
            </div>
          </div>
          <?php endforeach; ?>
        </div>
    ...
    <div class="nn-accred">
      <span><i class="fa-solid fa-circle-check"></i> Nepal Tourism Board Lic. 179</span>
      <span><i class="fa-solid fa-circle-check"></i> TAAN Member 2342</span>
      <span><i class="fa-solid fa-circle-check"></i> CIWEC Hospital Travel Medicine Partner</span>
      <span><i class="fa-solid fa-circle-check"></i> International Porter Protection Group</span>
      <span><i class="fa-solid fa-circle-check"></i> Leave No Trace Master Educator</span>
    </div>
  </div>
</section>
    ...
    <div class="nn-rel">
      <div class="swiper nn-rev-swiper">
        <div class="swiper-wrapper">
          <!-- Video review -->
          <div class="swiper-slide">
            <article class="nn-vcard" style="background-image:url('https://images.unsplash.com/photo-1551632811-561732d1e306?auto=format&amp;fit=crop&amp;w=800&amp;q=80');">
          ...
          <?php
          $revs = [
            ['Aoife Walsh','Ireland &middot; Manaslu Circuit &middot; Mar 2026'],
            ['James Carter','UK &middot; Everest Base Camp &middot; Feb 2026'],
            ['Lena Fischer','Germany &middot; Annapurna &middot; Jan 2026'],
            ['Sofia Rossi','Italy &middot; Langtang &middot; Dec 2025'],
          ];
          foreach ($revs as $i => $r): ?>
          <div class="swiper-slide">
            <article class="nn-qcard">
              <span class="nn-stars nn-stars--lg">&#9733;&#9733;&#9733;&#9733;&#9733;</span>
              <p class="nn-qcard__text">&ldquo;Mohan answered every email within an hour for three weeks while we planned. Then on the trail our guide Pemba caught my altitude sickness a day before I would have. They were ready for everything before we knew to ask.&rdquo;</p>
              <div class="nn-qcard__who">
                <span class="nn-avatar"><?= strtoupper(substr($r[0],0,1)) ?></span>
                <span><strong><?= $r[0] ?></strong><span class="nn-muted"><?= $r[1] ?></span></span>
              </div>
            </article>
          </div>
          <?php endforeach; ?>
...
<section class="nn-sec nn-insta">
  <div class="container">
    ...
    <div class="row g-3">
      ...
      foreach ($posts as $p): ?>
      <div class="col-md-4">
        <a href="#" class="nn-igcard" style="background-image:url('https://images.unsplash.com/<?= $p[0] ?>?auto=format&amp;fit=crop&amp;w=700&amp;q=80');">
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4">
        <article class="nn-blog">
          <a href="blog-detail.php" class="nn-blog__img" style="background-image:url('https://images.unsplash.com/<?= $bl[5] ?>?auto=format&amp;fit=crop&amp;w=700&amp;q=80');"></a>
          <div class="nn-blog__body">
            <div class="nn-blog__meta"><span><?= $bl[1] ?></span> &middot; <span><?= $bl[2] ?></span> &middot; <span><?= $bl[3] ?></span></div>
...
<section class="nn-sec nn-trust">
  <div class="container text-center">
    <span class="nn-eyebrow nn-eyebrow--center"><span class="nn-eyebrow__line"></span>Recognised &middot; Certified &middot; Trusted<span class="nn-eyebrow__line"></span></span>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    var common = function (sel, prev, next) {
      return { slidesPerView: 1, spaceBetween: 24,
